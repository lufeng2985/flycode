# ProviderObservers | Riverpod

A [ProviderObserver](https://pub.dev/documentation/hooks_riverpod/latest/hooks_riverpod/ProviderObserver-class.html) is an object used to observe provider lifecycle events in the application.
They are generally used for logging, analytics, or debugging purposes.

## Usage

To use a [ProviderObserver](https://pub.dev/documentation/hooks_riverpod/latest/hooks_riverpod/ProviderObserver-class.html), you need to extend the class and override the life-cycles you want to observe.
There are many methods available. It is recommended to check its [documentation](https://pub.dev/documentation/hooks_riverpod/latest/hooks_riverpod/ProviderObserver-class.html) for more details.
...
To use this observer, pass it to your `ProviderScope`:
...
> If the state of a provider is mutated, (typically Lists, combined with [Ref.notifyListeners](https://pub.dev/documentation/hooks_riverpod/latest/hooks_riverpod/Ref/notifyListeners.html)),
